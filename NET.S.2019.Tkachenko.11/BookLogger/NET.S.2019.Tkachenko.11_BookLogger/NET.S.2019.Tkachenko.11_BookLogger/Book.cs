namespace NET.S._2019.Tkachenko._11
{
    ...
    public class Book : IComparable
    {
        ...
        public string GetStringRepresentation(BookTags[] tags)
        {
            ...
            {
                bookLogger.Error($"There can't be more than {BookTagsInfo.existingTagsCount} tags. There was an attempt to write {tags.Length} tags.");
        ...
        public int CompareTo(object obj)
        {
            ...
            {
                bookLogger.Error($"There was an attempt to compare two different objects. Object1: {this.GetType()}; Object2: {obj.GetType()}");
